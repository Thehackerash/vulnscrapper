...
const fs = require("fs");
const crypto = require("crypto"); // Import crypto module to create hashes
...
(async () => {
  try {
    ...
    const url = "https://helpx.adobe.com/security";
    ...
    // Filter links to include only those from the adobe.com domain
